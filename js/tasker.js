...
/**
 * Update the input fields with the object data passed
 * by parameter
 * 
 * @public
 *
 ...
 */
function updateEditTaskDialog(dialog, oTask) {
	"use strict";
    setCombos(oTask);
...
function openEditTaskDialog(dialog, oTask, taskTitle) {
    ...
    updateEditTaskDialog(dlg_editTask, oTask);
...
/**
 * Sets the content of the combos fields
 * @public
 *
 * @param oTask. Object task used to set the selected values
 */
function setCombos(oTask) {
	"use strict";
	// Projects	
